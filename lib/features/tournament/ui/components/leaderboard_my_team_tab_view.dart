...
import 'package:quinientas_historias/features/tournament/ui/bloc/cubit/tournament_cubit.dart';
...
class _LeaderboardMyTeamTabViewState extends State<LeaderboardMyTeamTabView>
  ...
  _fetchPage(int pageKey) {
    if (mounted) {
      widget.cubit.getLeaderboard(pageKey, 'teams', onSuccess: (newPage) {
